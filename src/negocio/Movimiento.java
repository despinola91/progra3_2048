...
public class Movimiento {
	...
	protected static void moverArriba() {
		// int largo = Juego.matriz.length;
	...
	protected static void moverAbajo() {

	}

	protected static void moverIzquierda() {

	}

	protected static void moverDerecha() {
